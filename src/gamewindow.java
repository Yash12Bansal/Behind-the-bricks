...
public class gamewindow extends JFrame implements Runnable,KeyListener,Serializable,ActionListener
{
        ...
        if(tb<=0 && hitnoofbullets<4)
        {
           ...
           g.fillRect(ix1+200,iy2, 5, 30);
            ...
            System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
                 ImageIcon i2=new ImageIcon("monster2.jpg");
        
                 Image im2=i2.getImage();
                 
                    g.drawImage(im2, ix1,30,ix2, 350, 10, 3,550,170,Color.BLACK,this);
