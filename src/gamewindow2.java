...
public class gamewindow2 extends JFrame implements Runnable,KeyListener,Serializable,ActionListener
{
     ...
     g.setColor(Color.RED);
        g.fillOval(bx, by, 22,22);
            ...
            Color cl=new Color(r,gr,b);
                    ...
                    Color cc=new Color(reda,ggr,blu); 
        ...
        if(tb<=0 && hitnoofbullets<4)
        {
           ...
           g.fillRect(ix1+200,iy2, 5, 30);
            ...
            System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
                 ImageIcon i2=new ImageIcon("monster5.jpg");
        
                 Image im2=i2.getImage();
                 
                    g.drawImage(im2, ix1,30,ix2, 350, 10, 100,950,800,Color.BLACK,this);
